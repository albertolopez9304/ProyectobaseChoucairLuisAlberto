...
public class ChoucairAcademyStepDefinitions {
    ...
    public void heSearchForTheCourseISTQBAgileTesterExtensionOnTheChoucairAcademyPlataform(List<AcademyChoucairData> academyChoucairData)
            throws Exception {
    ...
    public void heFindsTheCourseCalledISTQBAgileTesterExtensionResources(List<AcademyChoucairData> academyChoucairData) throws Exception {
